...
import de.rubymc.rubyapi.gui.Inventories;
            ...
            if (player.hasPermission("rubyapi.statsadmin")) {
                ...
                if (args.length == 5) {
                    ...
                    if (target.isOnline()) {
                        ...
                        player.sendMessage(prefix + "Du siehst nun die Stats von §b" + target.getName());
                        Inventories.openStats(player, target);
                    ...
                    Inventories.openStats(player, player);
